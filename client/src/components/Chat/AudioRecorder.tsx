...
export default function AudioRecorder({ onCancel, onFinish }: AudioRecorderProps) {
  ...
  return (
    <div className="flex items-center gap-3 px-2 py-2 rounded-lg bg-zinc-800/60 border border-zinc-700">
      <span className="w-3 h-3 rounded-full bg-red-500 animate-pulse flex-shrink-0" aria-hidden />
